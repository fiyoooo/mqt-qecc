...
OsdDecoder::OsdDecoder(
        ldpc::bp::BpSparse&  parity_check_matrix,
        OsdMethod            osd_method,
        int                  osd_order,
        std::vector<double>& channel_probs) : pcm(parity_check_matrix), channel_probabilities(channel_probs) {
...
std::vector<uint8_t>& OsdDecoder::decode(std::vector<uint8_t>& syndrome, std::vector<double>& log_prob_ratios) {
